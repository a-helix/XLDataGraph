...
all_fastas = Fasta_Dataset(fasta_folder_path, 'Uniprot')
    
# Read zhrm files from the folder
zhrm_folder_path = PathUtil.list_specified_type_files_from_folder(CWD, '.zhrm')   
sorted_zhrm_file_path = DatasetUtil.read_merox_zhrm_files_from_path_list(zhrm_folder_path)
...
combined_replicas = DatasetUtil.combine_replicas_in_xl_dataset(filtered_score_folder_content, n=4)
